...
- [diagnose](diagnose/SKILL.md): bucle disciplinado de diagnostico para bugs dificiles y regresiones de rendimiento.
- [grill-me](grill-me/SKILL.md): somete planes o disenios a preguntas una por una hasta lograr entendimiento compartido.
...
[`planning-with-files/`](planning-with-files/) usa [`OthmanAdi/planning-with-files/skills/planning-with-files`](https://github.com/OthmanAdi/planning-with-files/tree/master/skills/planning-with-files) como baseline upstream. Este repositorio conserva el nombre generico `planning-with-files` y omite metadatos de paquete especificos del repositorio upstream para mantener compatibilidad con flujos `SKILL.md` estandar.
...
| [kimi-webbridge](kimi-webbridge/SKILL.md)                           | Controla el navegador real del usuario mediante un daemon local para navegacion, formularios, capturas, lectura de paginas y sesiones autenticadas.                                                                 | [install.sh](https://kimi-web-img.moonshot.cn/webbridge/install.sh)                                                             |
...
| [diagnose](diagnose/SKILL.md)                                   | Bucle disciplinado de diagnostico para bugs dificiles y regresiones de rendimiento.                                                                 | [mattpocock/skills](https://github.com/mattpocock/skills/tree/main/skills/engineering/diagnose)                                |
